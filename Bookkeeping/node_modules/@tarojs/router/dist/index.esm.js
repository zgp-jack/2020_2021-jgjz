...
var Route = /*#__PURE__*/function (_Taro$Component) {
  ...
  function Route(props, context) {
    ...
    _this.customRoutes = toPairs_1(_this.props.customRoutes);
  ...
  _createClass(Route, [{
    ...
    value: function computeMatch(currentLocation) {
      var isIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.props.isIndex;
      var isTabBar = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.props.isTabBar;
      var pathname = currentLocation.path;
    ...
    value: function updateComponent() {
      ...
      props.componentLoader().then(function (_ref3) {
    ...
    value: function componentWillReceiveProps(nProps) {
      ...
      var nextMatched = this.computeMatch(nProps.currentLocation, nProps.isIndex, nProps.isTabBar);
...
var Router = /*#__PURE__*/function (_Taro$Component) {
  ...
  _createClass(Router, [{
    ...
    key: "isTabBar",
    value: function isTabBar(originalPathname) {
      var pathname = originalPathname;
      var foundRoute = this.customRoutes.filter(function (_ref4) {
        var _ref5 = _slicedToArray(_ref4, 2),
            originalRoute = _ref5[0],
            mappedRoute = _ref5[1];
    ...
    value: function pop(toLocation, fromLocation) {
      var isTabBar = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    value: function _switch(toLocation) {
      ...
      var index = routeStack.findIndex(function (e) {
        return e.path === toLocation.path || _this3.customRoutes.findIndex(function (_ref6) {
          var _ref7 = _slicedToArray(_ref6, 2),
              originalRoute = _ref7[0],
              mappedRoute = _ref7[1];
    ...
    value: function componentDidMount() {
      ...
      this.unlisten = history.listen(function (_ref8) {
        var fromLocation = _ref8.fromLocation,
            toLocation = _ref8.toLocation,
            action = _ref8.action;

        var isTabBar = _this4.isTabBar(toLocation.path);

        if (action === "POP") {
          _this4.pop(toLocation, fromLocation, isTabBar);
        } else if (isTabBar) {
          _this4.switch(toLocation, isTabBar);
        } else {
          if (action === "PUSH") {
            _this4.push(toLocation, isTabBar);
          } else {
            _this4.replace(toLocation, isTabBar);
          }
        }

        _this4.lastLocation = history.location;
    ...
    value: function render() {
      ...
      }, this.state.routeStack.map(function (_ref9, k) {
        var path = _ref9.path,
            componentLoader = _ref9.componentLoader,
            isIndex = _ref9.isIndex,
            isTabBar = _ref9.isTabBar,
            key = _ref9.key,
            isRedirect = _ref9.isRedirect;
        return Nerv.createElement(Route, {
          path: path,
          customRoutes: _this5.props.customRoutes,
          ...
          collectComponent: _this5.collectComponent
        });
      }));
    }
  }]);
