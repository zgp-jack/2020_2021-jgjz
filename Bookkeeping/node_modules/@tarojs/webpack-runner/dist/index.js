...
const base_conf_1 = require("./config/base.conf");
...
const buildProd = (appPath, config) => __awaiter(void 0, void 0, void 0, function* () {
    const baseWebpackChain = base_conf_1.default(appPath);
    yield customizeChain(baseWebpackChain, config.modifyWebpackChain, config.webpackChain);
    const prodWebpackConf = prod_conf_1.default(appPath, config, baseWebpackChain);
...
const buildDev = (appPath, config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const baseWebpackChain = base_conf_1.default(appPath);
    yield customizeChain(baseWebpackChain, config.modifyWebpackChain, config.webpackChain);
    const devWebpackConf = dev_conf_1.default(appPath, config, baseWebpackChain);
