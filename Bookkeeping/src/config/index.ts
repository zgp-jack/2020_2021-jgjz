...
// * 全局请求接口域名
// * 测试站
export const DEVREQUESTURL: string = 'http://miniapi.zhaogong.vrtbbs.com/'
// * 正式站
...
// * 阿里云CDN图片域名
export const IMGCDNURL: string = ALIYUNCDN + '/mini/images/'
// * 公司默认客服电话
...
// 图片
export const IMAGE: string = 'userauth-icon.png'
