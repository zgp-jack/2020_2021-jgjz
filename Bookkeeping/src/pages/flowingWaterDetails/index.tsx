...
export default function FlowingWaterDetails() {
  ...
  加班： {obj.overtime_type == '1' ? <Text>按小时算<Text className='wages-list-blued'>{obj.wage_overtime_money}</Text>元/小时</Text> : <Text>按工天算<Text>{parseFloat(obj.wage_overtime)}</Text>小时算一个工<Text className='wages-list-blued'>{obj.wage_money/obj.wage_overtime}</Text>元/小时</Text>}
              </View>
            </View>
          </View>
          }
