...
var _App = function (_BaseComponent) {
  ...
  function _App() {
    ...
    _this.config = {
      pages: ['pages/index/index', 'pages/feedback/index', 'pages/recorder/index', 'pages/notepad/index', 'pages/addNotepad/index', 'pages/notepadDetails/index', 'pages/attendanceSheet/index', 'pages/download/index', 'pages/flowingWater/index', 'pages/flowingWaterDetails/index', 'pages/addTeamMember/index', 'pages/editDetails/index', 'pages/login/index', 'pages/share/index'],
      window: {
...
var GETDATALIST = exports.GETDATALIST = 'getDataList';
var SETDATALIST = exports.SETDATALIST = 'setDataList';
...
function clickTIme() {
  ...
  switch (action.type) {
    case _clickTIme.GETCLICKTIME:
      return state;
    case _clickTIme.SETCLICKTIME:
...
var _user = __webpack_require__(/*! ./user */ "./src/reducers/user.ts");

var _user2 = _interopRequireDefault(_user);

var _notepad = __webpack_require__(/*! ./notepad */ "./src/reducers/notepad.ts");

var _notepad2 = _interopRequireDefault(_notepad);

var _flowingWater = __webpack_require__(/*! ./flowingWater */ "./src/reducers/flowingWater.ts");

var _flowingWater2 = _interopRequireDefault(_flowingWater);

var _list = __webpack_require__(/*! ./list */ "./src/reducers/list.ts");

var _list2 = _interopRequireDefault(_list);

var _workerList = __webpack_require__(/*! ./workerList */ "./src/reducers/workerList.ts");

var _workerList2 = _interopRequireDefault(_workerList);

var _clickTIme = __webpack_require__(/*! ./clickTIme */ "./src/reducers/clickTIme.ts");

var _clickTIme2 = _interopRequireDefault(_clickTIme);

var _mailList = __webpack_require__(/*! ./mailList */ "./src/reducers/mailList.ts");

var _mailList2 = _interopRequireDefault(_mailList);

var _type = __webpack_require__(/*! ./type */ "./src/reducers/type.ts");
...
exports.default = (0, _redux.combineReducers)({
  ...
  flowingWater: _flowingWater2.default,
  list: _list2.default,
...
var _list = __webpack_require__(/*! ../constants/list */ "./src/constants/list.ts");
...
function list() {
  ...
  switch (action.type) {
    case _list.GETDATALIST:
      return state;
    case _list.SETDATALIST:
      return [].concat(_toConsumableArray(action.data));
    default:
      return state;
  }
...
function mailList() {
  ...
  switch (action.type) {
    case _mailList.GETMAIILIST:
      return state;
    case _mailList.SETMAIILIST:
      return [].concat(_toConsumableArray(action.data));
    default:
      return state;
  }
...
var _user = __webpack_require__(/*! ../constants/user */ "./src/constants/user.ts");
...
function workerList() {
  ...
  switch (action.type) {
    case _workerList.GETWORKERTYPE:
      return state;
    case _workerList.SETWORKERTYPE:
      return [].concat(_toConsumableArray(action.data));
    default:
      return state;
  }
