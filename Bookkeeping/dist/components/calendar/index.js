...
var CalendarModal = (_temp2 = _class = function (_Taro$Component) {
  ...
  function CalendarModal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CalendarModal.__proto__ || Object.getPrototypeOf(CalendarModal)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray51", "display", "IMGCDNURL", "weeks", "calendarDays", "recorderType", "time", "handleClickCalendar", "getMonthDaysCurrent", "handleCalendar", "setModel", "model", "setTimeData", "arr", "clickData", "handleCalendarClose", "handleChangeTime", "handleCalendarSub", "__fn_onClick", "onScrollToUpper", "onScrollToLower"], _this.anonymousFunc2Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(CalendarModal, [{
    ...
    value: function _createData() {
      ...
      var loopArray51 = display ? calendarDays.map(function (v, i) {
        v = {
