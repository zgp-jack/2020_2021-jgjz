...
var CalendarModal = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(CalendarModal, [{
    ...
    key: "funPrivatecdbzz",
    value: function funPrivatecdbzz() {
      return this.props.handleClose.apply(undefined, Array.prototype.slice.call(arguments, 1));
    }
  }]);

  return CalendarModal;
}(_taroWeapp2.default.Component), _class.$$events = ["anonymousFunc0", "funPrivatecdbzz"], _class.$$componentPath = "components/attendanceModal/index", _temp2);
