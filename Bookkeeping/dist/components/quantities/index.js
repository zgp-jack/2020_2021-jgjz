...
var Quantities = (_temp2 = _class = function (_Taro$Component) {
  ...
  return Quantities;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivategjzzz", "anonymousFunc0"], _class.$$componentPath = "components/quantities/index", _temp2);
