...
var WageStandard = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(WageStandard, [{
    ...
    value: function _createData() {
      ...
      var loopArray40 = display ? wageStandard.data.map(function (v, __index2) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "iizzz" + __index2;
  ...
  return WageStandard;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivateigzzz", "funPrivateihzzz", "anonymousFunc2"], _class.$$componentPath = "components/wageStandard/index", _temp2);
