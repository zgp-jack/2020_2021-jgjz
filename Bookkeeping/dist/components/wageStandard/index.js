...
var WageStandard = (_temp2 = _class = function (_Taro$Component) {
  ...
  function WageStandard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WageStandard.__proto__ || Object.getPrototypeOf(WageStandard)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["wageStandard", "loopArray131", "$compid__306", "$compid__307", "$compid__308", "$compid__309", "display", "handleClose", "handleWageStandard", "handleAddWage", "handleWageStandardRadio", "__fn_onClick"], _this.anonymousFunc2Map = {}, _this.customComponents = ["AtInputNumber"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(WageStandard, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__306"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__306 = _genCompid2[0],
          $compid__306 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__307"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__307 = _genCompid4[0],
          $compid__307 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__308"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__308 = _genCompid6[0],
          $compid__308 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__309"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__309 = _genCompid8[0],
          $compid__309 = _genCompid8[1];
      ...
      var loopArray131 = display ? wageStandard.data.map(function (v, __index2) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "cbbzz" + __index2;
  ...
  return WageStandard;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivatecajzz", "funPrivatecbazz", "anonymousFunc2"], _class.$$componentPath = "components/wageStandard/index", _temp2);
