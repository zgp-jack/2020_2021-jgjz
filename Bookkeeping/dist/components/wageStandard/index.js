...
var WageStandard = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(WageStandard, [{
    ...
    value: function _createData() {
      ...
      var loopArray46 = display ? wageStandard.data.map(function (v, __index2) {
        v = {
  ...
  return WageStandard;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivatejazzz", "funPrivatejbzzz", "anonymousFunc2"], _class.$$componentPath = "components/wageStandard/index", _temp2);
