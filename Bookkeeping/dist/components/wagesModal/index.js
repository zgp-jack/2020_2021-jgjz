...
var WagesModal = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(WagesModal, [{
    ...
    value: function _createData() {
      ...
      var loopArray40 = tab === 1 ? moneyList.map(function (v, __index7) {
        ...
        var _$indexKey4 = "ifzzz" + __index7;
  ...
  return WagesModal;
}(_taroWeapp2.default.Component), _class.$$events = ["anonymousFunc0", "anonymousFunc1", "anonymousFunc2", "anonymousFunc3", "funPrivatehizzz", "funPrivatehjzzz", "anonymousFunc4", "funPrivateibzzz", "anonymousFunc5", "anonymousFunc6", "funPrivateiezzz", "anonymousFunc7"], _class.$$componentPath = "components/wagesModal/index", _temp2);
