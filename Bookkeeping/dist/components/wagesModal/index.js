...
var WagesModal = (_temp2 = _class = function (_Taro$Component) {
  ...
  function WagesModal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WagesModal.__proto__ || Object.getPrototypeOf(WagesModal)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray39", "loopArray40", "loopArray41", "display", "tab", "data", "standard", "moneyList", "clickModalNum", "handleClose", "handleAddStandard", "handleEditWages", "handleAtSwitch", "handleSetWagesModal", "handleWagesList", "handleCheckboxStandard", "handleAllClick", "__fn_onClick"], _this.anonymousFunc4Map = {}, _this.anonymousFunc5Map = {}, _this.anonymousFunc6Map = {}, _this.anonymousFunc7Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(WagesModal, [{
    ...
    value: function _createData() {
      ...
      var loopArray39 = data && data.length > 0 ? data.map(function (v, __index4) {
        v = {
      ...
      var loopArray40 = tab === 0 ? standard.map(function (v, i) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray41 = tab === 1 ? moneyList.map(function (v, __index7) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
