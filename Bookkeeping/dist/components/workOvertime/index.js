...
var WorkOvertime = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(WorkOvertime, [{
    ...
    value: function _createData() {
      ...
      var loopArray42 = display ? dataArr.map(function (v, __index1) {
        ...
        var _$indexKey2 = "hbzzz" + __index1;
  ...
  return WorkOvertime;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivategizzz", "funPrivategjzzz", "anonymousFunc0", "anonymousFunc1"], _class.$$componentPath = "components/workOvertime/index", _temp2);
