...
var WorkOvertime = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(WorkOvertime, [{
    ...
    value: function _createData() {
      ...
      var loopArray44 = display ? data.map(function (v, __index0) {
        v = {
      ...
      var loopArray45 = display ? dataArr.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "jgzzz" + __index1;
  ...
  return WorkOvertime;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivatejdzzz", "funPrivatejezzz", "anonymousFunc0", "anonymousFunc1"], _class.$$componentPath = "components/workOvertime/index", _temp2);
