...
// 记工时间
var RecordTime = exports.RecordTime = 'recordTime';
...
function userForeman() {
  ...
  var _useState17 = (0, _taroWeapp.useState)(1),
      ...
      recorderType = _useState18[0],
      setRecorderType = _useState18[1];
  ...
  var _useState21 = (0, _taroWeapp.useState)([]),
      ...
      foreman = _useState22[0],
      setForeman = _useState22[1];
  // 班组长名字


  var _useState23 = (0, _taroWeapp.useState)(''),
      _useState24 = _slicedToArray(_useState23, 2),
      foremanTitle = _useState24[0],
      setForemanTitle = _useState24[1];
  // 工人


  var _useState25 = (0, _taroWeapp.useState)([]),
      _useState26 = _slicedToArray(_useState25, 2),
      workerItem = _useState26[0],
      setWorkerItem = _useState26[1];
  // 选择加班时长弹窗


  var _useState27 = (0, _taroWeapp.useState)(false),
      _useState28 = _slicedToArray(_useState27, 2),
      workOvertimeDisplay = _useState28[0],
      setWorkOvertimeDisplay = _useState28[1];
  // 上班时长选择


  var _useState29 = (0, _taroWeapp.useState)(false),
      _useState30 = _slicedToArray(_useState29, 2),
      workingHoursDisplay = _useState30[0],
      setWorkingHoursDisplay = _useState30[1];
  // 上班时长选择类型


  var _useState31 = (0, _taroWeapp.useState)(0),
      _useState32 = _slicedToArray(_useState31, 2),
      timeType = _useState32[0],
      setTimeType = _useState32[1];
  // 填写班组


  var _useState33 = (0, _taroWeapp.useState)(false),
      _useState34 = _slicedToArray(_useState33, 2),
      project = _useState34[0],
      setProject = _useState34[1];
  // 单位


  var _useState35 = (0, _taroWeapp.useState)('平方米'),
      _useState36 = _slicedToArray(_useState35, 2),
      unit = _useState36[0],
      setUnit = _useState36[1];
  // 工程量


  var _useState37 = (0, _taroWeapp.useState)(false),
      _useState38 = _slicedToArray(_useState37, 2),
      quantitiesDisplay = _useState38[0],
      setQuantitiesDisplay = _useState38[1];
  // 添加成员


  var _useState39 = (0, _taroWeapp.useState)(false),
      _useState40 = _slicedToArray(_useState39, 2),
      addMemberDisplay = _useState40[0],
      setAddMemberDisplay = _useState40[1];
  // 用户数据
  ...
  var _useState41 = (0, _taroWeapp.useState)({
    ...
    click: false
      ...
      obj = _useState42[0],
      setObj = _useState42[1];

  var _useState43 = (0, _taroWeapp.useState)(0),
      _useState44 = _slicedToArray(_useState43, 2),
      contractor = _useState44[0],
      setContractor = _useState44[1];
  // 图片
  ...
  var _useState47 = (0, _taroWeapp.useState)({
    item: [{ id: 0, name: '按天记工', click: true }, { id: 1, name: '按量计算', click: false }]
      ...
      contractorArr = _useState48[0],
      setContractorArr = _useState48[1];
  // 修改项目
  ...
  var _useState51 = (0, _taroWeapp.useState)({
    item: [{ id: 1, name: '点工', click: true }, { id: 2, name: '包工 ', click: false }, { id: 3, name: '借支', click: false }]
      ...
      recorderTypeArr = _useState52[0],
      setRecorderTypeArr = _useState52[1];
  // 修改项目


  var _useState53 = (0, _taroWeapp.useState)(false),
      _useState54 = _slicedToArray(_useState53, 2),
      editProjectDisplay = _useState54[0],
      setEditProjectDisplay = _useState54[1];
  // 删除


  var _useState55 = (0, _taroWeapp.useState)(false),
      _useState56 = _slicedToArray(_useState55, 2),
      delType = _useState56[0],
      setDeldelType = _useState56[1];
  // 工资


  var _useState57 = (0, _taroWeapp.useState)(false),
      _useState58 = _slicedToArray(_useState57, 2),
      wagesModalDisplay = _useState58[0],
      setWagesModalDisplay = _useState58[1];
  // 工资标准


  var _useState59 = (0, _taroWeapp.useState)(false),
      _useState60 = _slicedToArray(_useState59, 2),
      wageStandardDisplay = _useState60[0],
      setWageStandardDisplay = _useState60[1];
  // 项目列表


  var _useState61 = (0, _taroWeapp.useState)([]),
      _useState62 = _slicedToArray(_useState61, 2),
      projectArr = _useState62[0],
      setProjectArr = _useState62[1];
  // 项目id
  ...
  var _useState63 = (0, _taroWeapp.useState)(''),
      ...
      ids = _useState64[0],
      setIds = _useState64[1];
  // 判断工资标准修改类型


  var _useState65 = (0, _taroWeapp.useState)(0),
  ...
  var _useState67 = (0, _taroWeapp.useState)([]),
      ...
      memberList = _useState68[0],
      setMemberList = _useState68[1];
  // 工人列表


  var _useState69 = (0, _taroWeapp.useState)(),
      _useState70 = _slicedToArray(_useState69, 2),
      workerList = _useState70[0],
      setWorkerList = _useState70[1];
  //储存工人


  var _useState71 = (0, _taroWeapp.useState)([]),
      _useState72 = _slicedToArray(_useState71, 2),
      storagelist = _useState72[0],
      setStoragelist = _useState72[1];
  // 工资标准


  var _useState73 = (0, _taroWeapp.useState)([]),
      _useState74 = _slicedToArray(_useState73, 2),
      standard = _useState74[0],
      setStandard = _useState74[1];
  // 已设置工资标准


  var _useState75 = (0, _taroWeapp.useState)([]),
      _useState76 = _slicedToArray(_useState75, 2),
      moneyList = _useState76[0],
      setMoneyList = _useState76[1];
  // 工资tab类型
  ...
  var _useState77 = (0, _taroWeapp.useState)(0),
      ...
      tab = _useState78[0],
      setTab = _useState78[1];
  // 选择人数


  var _useState79 = (0, _taroWeapp.useState)(0),
      _useState80 = _slicedToArray(_useState79, 2),
      clickNum = _useState80[0],
      setClickNum = _useState80[1];
  // 修改项目组数据
  ...
  var _useState81 = (0, _taroWeapp.useState)({
    ...
    group_name: ''
      ...
      editProjectData = _useState82[0],
      setEditProjectData = _useState82[1];
  // 模板id


  var _useState83 = (0, _taroWeapp.useState)(''),
      _useState84 = _slicedToArray(_useState83, 2),
      templateId = _useState84[0],
      setTemplateId = _useState84[1];
  // 设置工资标准里的工人


  var _useState85 = (0, _taroWeapp.useState)([]),
      _useState86 = _slicedToArray(_useState85, 2),
      setWorkList = _useState86[0],
      setSetWorkList = _useState86[1];
  // group_info


  var _useState87 = (0, _taroWeapp.useState)(''),
      _useState88 = _slicedToArray(_useState87, 2),
      groupInfo = _useState88[0],
      setGroupInfo = _useState88[1];
  // 添加标准


  var _useState89 = (0, _taroWeapp.useState)(0),
      _useState90 = _slicedToArray(_useState89, 2),
      addStandard = _useState90[0],
      setAddStandard = _useState90[1];
  // 日历（不等于借支）


  var _useState91 = (0, _taroWeapp.useState)([]),
      _useState92 = _slicedToArray(_useState91, 2),
      timeData = _useState92[0],
      setTimeData = _useState92[1];
  // modal选择工人


  var _useState93 = (0, _taroWeapp.useState)(0),
      _useState94 = _slicedToArray(_useState93, 2),
      clickModalNum = _useState94[0],
      setClickModalNum = _useState94[1];
  // 刷新


  var _useState95 = (0, _taroWeapp.useState)(false),
      _useState96 = _slicedToArray(_useState95, 2),
      refresh = _useState96[0],
      setRefresh = _useState96[1];
  // 触摸时间设置


  var _useState97 = (0, _taroWeapp.useState)(),
      _useState98 = _slicedToArray(_useState97, 2),
      endTime = _useState98[0],
      setEndTime = _useState98[1];

  var _useState99 = (0, _taroWeapp.useState)(),
      _useState100 = _slicedToArray(_useState99, 2),
      startTime = _useState100[0],
      setStartTime = _useState100[1];
  // 日历
  // 日历


  var _useState101 = (0, _taroWeapp.useState)(false),
      _useState102 = _slicedToArray(_useState101, 2),
      calendarModalDisplay = _useState102[0],
      setCalendarModalDisplay = _useState102[1];
  // 获取当月天数


  var _useState103 = (0, _taroWeapp.useState)([]),
      _useState104 = _slicedToArray(_useState103, 2),
      calendarDays = _useState104[0],
      setCalendarDays = _useState104[1];
  // 设置点击了的日历


  var _useState105 = (0, _taroWeapp.useState)([]),
      _useState106 = _slicedToArray(_useState105, 2),
      clickData = _useState106[0],
      setClickData = _useState106[1];

  var _useState107 = (0, _taroWeapp.useState)([]),
      _useState108 = _slicedToArray(_useState107, 2),
      arr = _useState108[0],
      setArr = _useState108[1];
  // 设置打开日时点击的值


  var _useState109 = (0, _taroWeapp.useState)([]),
      _useState110 = _slicedToArray(_useState109, 2),
      openClickTime = _useState110[0],
      setOpenClickTime = _useState110[1];
  // 刷新
  //农历1949-2100年查询表
  ...
  var _useState111 = (0, _taroWeapp.useState)({
    year: '',
    monent: ''
  }),
      _useState112 = _slicedToArray(_useState111, 2),
      time = _useState112[0],
      setTime = _useState112[1];
  // 设置存redux的日期


  var _useState113 = (0, _taroWeapp.useState)([]),
      _useState114 = _slicedToArray(_useState113, 2),
      reduxTime = _useState114[0],
      setReduxTime = _useState114[1];
  // 工资标准全选


  var _useState115 = (0, _taroWeapp.useState)(false),
      _useState116 = _slicedToArray(_useState115, 2),
      checkAll = _useState116[0],
      setCheckAll = _useState116[1];
  ...
  var handleClickCalendar = function handleClickCalendar(v) {
    ...
    var clickDataItem = JSON.parse(JSON.stringify(clickData));
    ...
    var openClickData = JSON.parse(JSON.stringify(openClickTime));
      ...
      if (v.date == calendarDaysArr[i].date && v.month == calendarDaysArr[i].month && v.year == calendarDaysArr[i].year && !v.up && !v.next) {
        ...
        if (clickDataItem.length > 30) {
          if (calendarDaysArr[i].click) {
            ...
            // 判断是true时候删除
            if (calendarDaysArr[i].click) {
              console.log([].concat(_toConsumableArray(clickDataItem), [calendarDaysArr[i]]), '[...clickDataItem, calendarDaysArr[i]];');
              data = [].concat(_toConsumableArray(clickDataItem), [calendarDaysArr[i]]);
              // 增加
            } else {
              // calendarDaysArr.sp
              for (var j = 0; j < clickDataItem.length; j++) {
              ...
              data = [].concat(_toConsumableArray(clickDataItem));
            }
            console.log(data, 'data');
            setClickData(data);
          } else {
            (0, _index3.default)('最多选择31天');
            return;
          }
        } else {
          calendarDaysArr[i].click = !calendarDaysArr[i].click;
          ...
          if (calendarDaysArr[i].click) {
            console.log([].concat(_toConsumableArray(clickDataItem), [calendarDaysArr[i]]), '[...clickDataItem, calendarDaysArr[i]];');
            _data = [].concat(_toConsumableArray(clickDataItem), [calendarDaysArr[i]]);
            // 增加
          } else {
            // calendarDaysArr.sp
            for (var _j = 0; _j < clickDataItem.length; _j++) {
              if (clickDataItem[_j].date == calendarDaysArr[i].date && clickDataItem[_j].month == calendarDaysArr[i].month && clickDataItem[_j].year == calendarDaysArr[i].year) {
                clickDataItem.splice(_j, 1);
              }
            }
            _data = [].concat(_toConsumableArray(clickDataItem));
          }
        ...
        for (var _i3 = 0; _i3 < calendarDaysArr.length; _i3++) {
          if (calendarDaysArr[_i3].click) {
            ...
            showData.push(calendarDaysArr[_i3]);
          }
        }
  ...
  var getMonthDaysCurrent = function getMonthDaysCurrent(e) {
    ...
    // 获取记录过的日历
    var calendarItem = _taroWeapp2.default.getStorageSync(_store.Calendar);
    // if(calendarItem.length>0){
    // for (let j = 0; j < calendarItem.length;j++){
    // 当月显示的日期
    for (var _i4 = 1; _i4 <= days; _i4++) {
      var _lunarCalendarItem = sloarToLunar(year, month, _i4);
      // 获取现在的时间的年月日
      ...
      calendarDaysArr.push({
        ...
        'month': month,
        'date': _i4,
        'day': new Date(year, month - 1, _i4).getDay(),
        'current': true,
        'lunarCalendarItem': _lunarCalendarItem.lunarDay,
        'selected': _i4 == date,
        'stop': years <= year && (months == month && dates < _i4 || months < month)
      });
    }
    // }
    // }else{
    ...
    // }
    // 下个月显示的天数及日期
    for (var _i5 = 1; _i5 < 7 - lastDay; _i5++) {
      var _date4 = new Date(year, month, _i5);
      ...
      if (data.length > 0) {
        for (var _i6 = 0; _i6 < calendarDaysArr.length; _i6++) {
          for (var j = 0; j < data[0].length; j++) {
            if (calendarDaysArr[_i6].year == data[0][j].year && calendarDaysArr[_i6].month == data[0][j].month && calendarDaysArr[_i6].day == data[0][j].day && calendarDaysArr[_i6].lunarCalendarItem == data[0][j].lunarCalendarItem) {
              calendarDaysArr[_i6].click = true;
            }
          }
        }
      }
    ...
    (0, _index.bkGetProjectTeamAction)({}).then(function (res) {
      if (res.code === 200) {
        ...
        if (_identity === 2) {
          ...
          if (!model.groupName) {
            ...
            if (res.data && res.data.length > 0) {
              for (var i = 0; i < res.data.length; i++) {
                ...
                if (res.data[0].leader_name) {
                  ...
                  // 设置值
                  dispatch((0, _workerList.setWorker)([res.data[0]]));
                } else {
                  setForemanTitle('');
                }
              }
            ...
            if (res.data && res.data.length > 0) {
              for (var _i7 = 0; _i7 < res.data.length; _i7++) {
                // res.data[0].click = true;
                console.log(res.data[_i7], 'groupNamegroupName');
                console.log(groupName, 'groupName');
                if (groupName === res.data[_i7].group_name + '-' + res.data[_i7].name) {
                  res.data[_i7].click = true;
                  // 清空
                  setModel(_extends({}, modalObj, { name: res.data[_i7].group_name + '-' + res.data[_i7].name }));
                  setForemanTitle('');
                }
              }
            } else {
          ...
          var _data2 = JSON.parse(JSON.stringify(timeArr));
          ...
          // ======
          setModel(_extends({}, modalObj, { duration: _duration }));
    ...
    (0, _index.bkGetWorkerAction)(params).then(function (res) {
      if (res.code === 200) {
          ...
          if (val === 1) {
            if (dataItem) {
              ...
              for (var _i8 = 0; _i8 < res.data.length; _i8++) {
                if (data.name_py === res.data[_i8].name_py) {
                  res.data[_i8].list.push(data);
                }
              }
            }
        ...
        for (var _i10 = 0; _i10 < res.data.length; _i10++) {
          for (var _j2 = 0; _j2 < res.data[_i10].list.length; _j2++) {
            arrDate.push(res.data[_i10].list[_j2]);
          }
        }
        // setWorkerItem(arr);
        dispatch((0, _userList.setUserList)(res.data));
  ...
  var handleAddProject = function handleAddProject() {
    ...
    (0, _index.bkAddProjectTeamAction)(params).then(function (res) {
      if (res.code === 200) {
        setIds(res.data);
        var name = model.groupName + '-' + model.teamName;
  ...
  var handleworkOvertime = function handleworkOvertime(type, val) {
    ...
    if (type === 1) {
      ...
      var addTime = void 0;
      for (var i = 0; i < addWorkArr.length; i++) {
      ...
      if (val.id != 4) {
        setModel(_extends({}, data, { duration: duration }));
      }
    } else {
      //加班时长
      var _arr3 = void 0;
      if (val.id != 2) {
        _arr3 = addWorkArr.map(function (v) {
          if (v.id === val.id) {
            v.click = !v.click;
          } else {
            if (v.id === 2) {
      ...
      for (var _i11 = 0; _i11 < timeArr.length; _i11++) {
        if (timeArr[_i11].click) {
          console.log(timeArr[_i11].id);
          if (timeArr[_i11].id == 3) {
            Time = '休息';
          } else {
            Time = '上班' + timeArr[_i11].name;
          }
          break;
        } else {
          Time = '休息';
      ...
      var _duration2 = void 0;
      if (val.id == 1) {
        _duration2 = Time + '无加班';
      } else {
        _duration2 = '上班' + Time + val.name;
      }
      if (val.id != 2) {
        setModel(_extends({}, data, { duration: _duration2 }));
      }
    }
  };
  // 加班时长弹框选择
  var handleWorkingHours = function handleWorkingHours(type, e) {
    ...
    if (type === 1) {
      ...
      setModel(_extends({}, Item, { duration: duration }));
    } else {
      var _data3 = addWorkArr.map(function (v) {
        if (v.id === 2) {
          v.name = e.name;
          v.click = true;
          v.num = e.num;
      ...
      setAddWorkArr(_data3);
      var Time = void 0;
      for (var _i12 = 0; _i12 < timeArr.length; _i12++) {
        if (timeArr[_i12].click) {
          if (timeArr[_i12].id == 3) {
            Time = '休息';
          } else {
            Time = '上班' + timeArr[_i12].name;
          }
          break;
        } else {
          Time = '休息';
      ...
      var _duration3 = void 0;
      _duration3 = Time + '加班' + e.name;
      setModel(_extends({}, Item, { duration: _duration3 }));
    }
  ...
  var handleWorkOvertimeOk = function handleWorkOvertimeOk() {
    ...
    if (identity === 2) {
      var _data4 = JSON.parse(JSON.stringify(wageStandard));
      // 获取上班时长
      var timeArrs = JSON.parse(JSON.stringify(timeArr));
      // 获取加班时长
      var addWorkArrs = JSON.parse(JSON.stringify(addWorkArr));
      //模板金额 
      var moneyNum = _data4.money;
      // 模板时间
      var workNum = _data4.work;
      //加班金钱
      var addWorkNum = _data4.addWork;
      // 加班时间
      var dayNum = _data4.day;
      // 上班时间
      var _time2 = 0;
      for (var i = 0; i < timeArrs.length; i++) {
        if (timeArrs[i].click) {
          ...
          if (timeArrs[i].id != 1 && timeArrs[i].id != 2 && timeArrs[i].id != 3) {
            _time2 = 1 / workNum * timeArrs[i].num;
            // 选择时间
          } else {
            if (timeArrs[i].id == 1) {
              // 等于模板时间
      ...
      if (_data4.type === 1) {
        // 按小时算 加班小时* 模板加班金额
        total = moneyNum / workNum * _time2 + addWorkNum * addTime;
      } else {
        // 按天算 每个工多少钱/模板定义的多少小时算一个工 * 加班时长
        total = moneyNum / workNum * _time2 + moneyNum / dayNum * addTime;
      }
  ...
  var handleWageStandard = function handleWageStandard(type, e) {
    if (type == 'day') {
      ...
      var _num2 = 0;
      if (item.money > 0 && e > 0) {
        _num2 = (item.money / e).toFixed(2);
      }
      item.dayAddWork = _num2;
    ...
    if (type === 'money') {
      ...
      var dayAddWork = void 0;
      if (_item.day == 0) {
        dayAddWork = 0;
      } else {
        dayAddWork = e / _item.day || 0;
      }
      _item[type] = e;
      _item.dayAddWork = dayAddWork.toFixed(2) || 0;
              ...
              if (resItem.code === 200) {
                ...
                (0, _index.bkAddBusinessAction)(params).then(function (resData) {
                  ...
                  if (resData.code === 200) {
                    ...
                    // 保存成功记忆日历
                    _taroWeapp2.default.setStorageSync(_store.Calendar, timeItem);
                    // 保存记工的时间和记工工人
      ...
      (0, _index.bkAddBusinessAction)(params).then(function (res) {
        ...
        if (res.code === 200) {
          if (type === 1) {
            ...
            // 日历
            var calendar = JSON.parse(JSON.stringify(calendarDays));
            for (var _i22 = 0; _i22 < calendar.length; _i22++) {
              calendar[_i22].click = false;
            }
            for (var _i23 = 0; _i23 < workerItemArr.length; _i23++) {
              workerItemArr[_i23].click = false;
            }
            setWorkerItem(workerItemArr);
            setAddWorkArr(addItmeArr);
            setTimeData([]);
  ...
  var handleUser = function handleUser() {
    ...
    var date = new Date(times).valueOf() + 86400000;
    var oldTime = _taroWeapp2.default.getStorageSync(_store.RecordTime);
    var userData = _taroWeapp2.default.getStorageSync(_store.User);
    // 设置了时间并大于今天
    if (oldTime && oldTime > date) {}
  };
  // 保存时间
  var handleRecordTime = function handleRecordTime(workers) {
    // 现在的时间
    var time = new Date();
    var times = time.getFullYear() + "-" + (time.getMonth() + 1) + "-" + time.getDate();
    var date = new Date(times).valueOf();
    // 时间
    _taroWeapp2.default.setStorageSync(_store.RecordTime, date);
    // 工人
    var user = _taroWeapp2.default.getStorageSync(_store.User);
    if (user.length > 0) {
      var _arr6 = user.concat(workers).filter(function (v, i, arr) {
        return arr.indexOf(v) === arr.lastIndexOf(v);
      });
      _taroWeapp2.default.setStorageSync(_store.User, _arr6);
    } else {
      _taroWeapp2.default.setStorageSync(_store.User, workers);
    }
  };
  // 点击项目
  ...
  var handleAddWage = function handleAddWage() {
    ...
    // 加班时间
    var addTime = 0;
    for (var _i24 = 0; _i24 < addWorkArrs.length; _i24++) {
      if (addWorkArrs[_i24].click) {
        addTime = addWorkArrs[_i24].num;
      }
    }
    // 获取
    if (identity == 2) {
      ...
      setModel(_extends({}, model, { workersWages: _num3 }));
  ...
  var handleWorkerItem = function handleWorkerItem(v) {
    ...
    if (recorderType === 3 || recorderType === 2 && id === 1) {
      ...
      for (var _i28 = 0; _i28 < data.length; _i28++) {
        if (v.id === data[_i28].id) {
          if (v.set) {
            data[_i28].click = !data[_i28].click;
          } else {
  ...
  var handleAllChange = function handleAllChange() {
    ...
    if (recorderTypes === 3 || recorderTypes === 2 && contractor == 1) {
      ...
      for (var _i30 = 0; _i30 < data.length; _i30++) {
        if (data[_i30].set) {
          Itme.push(data[_i30]);
          data[_i30].click = true;
        } else {
  ...
  var handleCalendarClose = function handleCalendarClose() {
    ...
    var clickDataItem = JSON.parse(JSON.stringify(clickData));
    // setClickData([]);
    var data = JSON.parse(JSON.stringify(openClickTime));
    var calendarDaysArr = JSON.parse(JSON.stringify(calendarDays));
    for (var i = 0; i < calendarDaysArr.length; i++) {
      for (var j = 0; j < data.length; j++) {
...
// 小程序跳转后 添加绑定手机号
var jumpBindTelUrl = exports.jumpBindTelUrl = _index.REQUESTURL + 'bk-member/applet-jump-bind-tel/';
...
exports.jumpBindTelAction = jumpBindTelAction;
