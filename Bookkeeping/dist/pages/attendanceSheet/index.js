...
var AttendanceSheet = (_temp2 = _class = function (_Taro$Component) {
  ...
  function AttendanceSheet() {
    ...
    }, _this.$usedState = ["$compid__295", "fixedTab", "tebArr", "year", "month"], _this.customComponents = ["CalendarModal"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AttendanceSheet, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__295"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__295 = _genCompid2[0],
          $compid__295 = _genCompid2[1];
