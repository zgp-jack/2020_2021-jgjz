...
var AddTeamMember = (_temp2 = _class = function (_Taro$Component) {
  ...
  function AddTeamMember() {
    ...
    }, _this.$usedState = ["loopArray50", "loopArray51", "$compid__55", "$compid__56", "data", "type", "letter"], _this.anonymousFunc2Map = {}, _this.anonymousFunc3Map = {}, _this.anonymousFunc5Map = {}, _this.customComponents = ["AtSearchBar", "AddMember"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AddTeamMember, [{
    ...
    value: function _createData() {
      ...
      var loopArray50 = data ? data.map(function (val, i) {
        val = {
        ...
        var $anonymousCallee__10 = data ? val.$original.list.map(function (v, __index2) {
          ...
          var _$indexKey = "babzz" + i + "-" + __index2;
      ...
      var loopArray51 = letter.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "badzz" + __index5;
