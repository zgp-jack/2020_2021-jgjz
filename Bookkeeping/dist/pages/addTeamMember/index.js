...
var AddTeamMember = (_temp2 = _class = function (_Taro$Component) {
  ...
  function AddTeamMember() {
    ...
    }, _this.$usedState = ["loopArray47", "loopArray48", "$compid__51", "$compid__52", "data", "type", "letter"], _this.anonymousFunc2Map = {}, _this.anonymousFunc3Map = {}, _this.anonymousFunc5Map = {}, _this.customComponents = ["AtSearchBar", "AddMember"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AddTeamMember, [{
    ...
    value: function _createData() {
      ...
      var loopArray47 = data ? data.map(function (val, i) {
        val = {
        ...
        var $anonymousCallee__9 = data ? val.$original.list.map(function (v, __index2) {
          ...
          var _$indexKey = "jhzzz" + i + "-" + __index2;
      ...
      var loopArray48 = letter.map(function (v, __index5) {
        ...
        var _$indexKey3 = "jjzzz" + __index5;
