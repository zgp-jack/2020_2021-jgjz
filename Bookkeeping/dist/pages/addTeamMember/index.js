...
var AddTeamMember = (_temp2 = _class = function (_Taro$Component) {
  ...
  function AddTeamMember() {
    ...
    }, _this.$usedState = ["loopArray102", "loopArray103", "$compid__188", "$compid__189", "data", "type", "letter"], _this.anonymousFunc2Map = {}, _this.anonymousFunc3Map = {}, _this.anonymousFunc5Map = {}, _this.customComponents = ["AtSearchBar", "AddMember"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AddTeamMember, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__188"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__188 = _genCompid2[0],
          $compid__188 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__189"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__189 = _genCompid4[0],
          $compid__189 = _genCompid4[1];
      ...
      var loopArray102 = data && data.length > 0 ? data.map(function (val, i) {
        val = {
      ...
      var loopArray103 = letter.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "bjdzz" + __index5;
