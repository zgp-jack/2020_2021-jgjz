...
var EditDetails = (_temp2 = _class = function (_Taro$Component) {
  ...
  function EditDetails() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditDetails.__proto__ || Object.getPrototypeOf(EditDetails)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["borrowing", "loopArray385", "$compid__884", "$compid__885", "$compid__886", "$compid__887", "businessType", "type", "typeName", "val", "identity", "unit"], _this.anonymousFunc9Map = {}, _this.customComponents = ["ImageView", "WageStandard", "WorkOvertime", "WorkingHours"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(EditDetails, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__884"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__884 = _genCompid2[0],
          $compid__884 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__885"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__885 = _genCompid4[0],
          $compid__885 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__886"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__886 = _genCompid6[0],
          $compid__886 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__887"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__887 = _genCompid8[0],
          $compid__887 = _genCompid8[1];
        ...
        if (id) {
          (0, _index4.bkBusinessOneAction)({ id: id }).then(function (res) {
            if (res.code === 200) {
              ...
              var newTime = newData.getFullYear() + '-' + addZero(newData.getMonth() + 1) + '-' + addZero(newData.getDate()) + '（今天）';
              obj.time = newTime;
      ...
      var handleWorkOvertimeOk = function handleWorkOvertimeOk() {
        ...
        if (standardObj.overtime_type == '1') {
          console.log('等于1');
      ...
      var handlesub = function handlesub() {
        ...
        var borrowingArr = JSON.parse(JSON.stringify(borrowing));
      ...
      var loopArray385 = businessType === 3 ? borrowing.item.map(function (v, __index9) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "baibz" + __index9;
      ...
      _taroWeapp.propsManager.set({
        ...
        "model": val
      }, $compid__886, $prevCompid__886);
      _taroWeapp.propsManager.set({
        "display": workingHoursDisplay,
        "handleWorkingHoursClose": handleWorkingHoursClose,
        "type": timeType,
        "handleWorkingHours": handleWorkingHours
      }, $compid__887, $prevCompid__887);
      Object.assign(this.__state, {
        borrowing: borrowing,
        loopArray385: loopArray385,
        $compid__884: $compid__884,
        $compid__885: $compid__885,
        $compid__886: $compid__886,
        $compid__887: $compid__887,
