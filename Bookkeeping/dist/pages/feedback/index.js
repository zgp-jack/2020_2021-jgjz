...
var Feedback = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    }, _this.$usedState = ["loopArray34", "$compid__43", "evaluate", "image", "PHONE"], _this.anonymousFunc1Map = {}, _this.customComponents = ["ImageView"], _temp), _possibleConstructorReturn(_this, _ret);
  }
