...
var Feedback = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Feedback() {
    ...
    }, _this.$usedState = ["loopArray65", "$compid__83", "evaluate", "image", "PHONE"], _this.anonymousFunc1Map = {}, _this.customComponents = ["ImageView"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Feedback, [{
    ...
    value: function _createData() {
      ...
      var loopArray65 = evaluate.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "bddzz" + __index1;
