...
var Foreman = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(Foreman, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__166"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__166 = _genCompid6[0],
          $compid__166 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__167"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__167 = _genCompid8[0],
          $compid__167 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__168"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__168 = _genCompid10[0],
          $compid__168 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__169"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__169 = _genCompid12[0],
          $compid__169 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__170"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__170 = _genCompid14[0],
          $compid__170 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__171"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__171 = _genCompid16[0],
          $compid__171 = _genCompid16[1];

      var _genCompid17 = (0, _taroWeapp.genCompid)(__prefix + "$compid__172"),
          _genCompid18 = _slicedToArray(_genCompid17, 2),
          $prevCompid__172 = _genCompid18[0],
          $compid__172 = _genCompid18[1];

      var _genCompid19 = (0, _taroWeapp.genCompid)(__prefix + "$compid__173"),
          _genCompid20 = _slicedToArray(_genCompid19, 2),
          $prevCompid__173 = _genCompid20[0],
          $compid__173 = _genCompid20[1];

      var _genCompid21 = (0, _taroWeapp.genCompid)(__prefix + "$compid__174"),
          _genCompid22 = _slicedToArray(_genCompid21, 2),
          $prevCompid__174 = _genCompid22[0],
          $compid__174 = _genCompid22[1];

      var _genCompid23 = (0, _taroWeapp.genCompid)(__prefix + "$compid__175"),
          _genCompid24 = _slicedToArray(_genCompid23, 2),
          $prevCompid__175 = _genCompid24[0],
          $compid__175 = _genCompid24[1];

      var _genCompid25 = (0, _taroWeapp.genCompid)(__prefix + "$compid__176"),
          _genCompid26 = _slicedToArray(_genCompid25, 2),
          $prevCompid__176 = _genCompid26[0],
          $compid__176 = _genCompid26[1];

      var _genCompid27 = (0, _taroWeapp.genCompid)(__prefix + "$compid__177"),
          _genCompid28 = _slicedToArray(_genCompid27, 2),
          $prevCompid__177 = _genCompid28[0],
          $compid__177 = _genCompid28[1];
      ...
      var loopArray101 = recorderTypeArr.item.map(function (v, __index0) {
        v = {
      ...
      var loopArray102 = recorderType === 2 ? contractorArr.item.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };
      ...
      var loopArray103 = identity === 1 ? workerItem.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "bejzz" + __index5;
      ...
      var loopArray104 = recorderType === 3 ? borrowing.item.map(function (v, __index19) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey7 = "bfdzz" + __index19;
