...
var Foreman = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(Foreman, [{
    ...
    value: function _createData() {
      ...
      var loopArray60 = recorderTypeArr.item.map(function (v, __index0) {
        v = {
      ...
      var loopArray61 = recorderType === 2 ? contractorArr.item.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "bbdzz" + __index1;
      ...
      var loopArray62 = identity === 1 ? workerItem.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "bbezz" + __index5;
      ...
      var loopArray63 = recorderType === 3 ? borrowing.item.map(function (v, __index19) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey7 = "bbizz" + __index19;
