...
var Foreman = (_temp2 = _class = function (_Taro$Component) {
  ...
  _createClass(Foreman, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__106"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__106 = _genCompid6[0],
          $compid__106 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__107"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__107 = _genCompid8[0],
          $compid__107 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__108"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__108 = _genCompid10[0],
          $compid__108 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__109"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__109 = _genCompid12[0],
          $compid__109 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__110"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__110 = _genCompid14[0],
          $compid__110 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__111"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__111 = _genCompid16[0],
          $compid__111 = _genCompid16[1];

      var _genCompid17 = (0, _taroWeapp.genCompid)(__prefix + "$compid__112"),
          _genCompid18 = _slicedToArray(_genCompid17, 2),
          $prevCompid__112 = _genCompid18[0],
          $compid__112 = _genCompid18[1];

      var _genCompid19 = (0, _taroWeapp.genCompid)(__prefix + "$compid__113"),
          _genCompid20 = _slicedToArray(_genCompid19, 2),
          $prevCompid__113 = _genCompid20[0],
          $compid__113 = _genCompid20[1];

      var _genCompid21 = (0, _taroWeapp.genCompid)(__prefix + "$compid__114"),
          _genCompid22 = _slicedToArray(_genCompid21, 2),
          $prevCompid__114 = _genCompid22[0],
          $compid__114 = _genCompid22[1];

      var _genCompid23 = (0, _taroWeapp.genCompid)(__prefix + "$compid__115"),
          _genCompid24 = _slicedToArray(_genCompid23, 2),
          $prevCompid__115 = _genCompid24[0],
          $compid__115 = _genCompid24[1];

      var _genCompid25 = (0, _taroWeapp.genCompid)(__prefix + "$compid__116"),
          _genCompid26 = _slicedToArray(_genCompid25, 2),
          $prevCompid__116 = _genCompid26[0],
          $compid__116 = _genCompid26[1];

      var _genCompid27 = (0, _taroWeapp.genCompid)(__prefix + "$compid__117"),
          _genCompid28 = _slicedToArray(_genCompid27, 2),
          $prevCompid__117 = _genCompid28[0],
          $compid__117 = _genCompid28[1];
      ...
      var loopArray77 = recorderTypeArr.item.map(function (v, __index0) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey = "bfbzz" + __index0;
      ...
      var loopArray78 = recorderType === 2 ? contractorArr.item.map(function (v, __index1) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey2 = "bfczz" + __index1;
      ...
      var loopArray79 = identity === 1 ? workerItem.map(function (v, __index5) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey3 = "bfdzz" + __index5;

        _this2.anonymousFunc5Map[_$indexKey3] = function () {
          return handleOpenWagesModal(v.$original);
        };

        var _$indexKey4 = "bfezz" + __index5;
      ...
      var loopArray80 = recorderType === 3 ? borrowing.item.map(function (v, __index19) {
        v = {
          $original: (0, _taroWeapp.internal_get_original)(v)
        };

        var _$indexKey7 = "bfhzz" + __index19;
